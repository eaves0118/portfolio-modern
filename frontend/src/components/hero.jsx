...
const Hero = () => {
  const slogan = "Hieu.Dev";
  const splitSlogan = slogan.split("");

  return (
    <section className="max-w-[1400px] px-5 mx-auto flex text-white justify-center items-center gap-5">
      <div className="w-1/2 w-full p-5">
        <div className="w-[700px] mx-auto flex flex-col gap-5 ">
          <span className="text-6xl font-bold ">Hi I'm</span>
          <h2
            className="text-8xl font-bold flex relative after:content-['']
      ...
      <div className="w-1/2 w-full p-5">
        <img
          className="w-[650px] h-auto object-cover mx-auto"
          style={{
